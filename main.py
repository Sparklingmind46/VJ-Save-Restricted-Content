...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Update Channel", url="https://t.me/Amit_0_1")]]), reply_to_message_id=message.id)
...
def save(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
	...
	if "https://t.me/+" in message.text or "https://t.me/joinchat/" in message.text:
		...
		if acc is None:
			bot.send_message(message.chat.id,f"**String Session is not Set, Humse na ho paayega maalik**", reply_to_message_id=message.id)
			return
...
def handle_private(message: pyrogram.types.messages_and_media.message.Message, chatid: int, msgid: int):
		...
		smsg = bot.send_message(message.chat.id, '__Downloading⚡__', reply_to_message_id=message.id)
